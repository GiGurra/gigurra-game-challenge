...
import se.gigurra.aichallenge.games.battleship.{BattleshipAi, BattleshipGame, BattleshipUtil, Segment, Ship, Shot, Vec2}

import scala.collection.JavaConversions._
import scala.collection.mutable.ArrayBuffer
import scala.util.Random

class SmartBattleshipAi extends BattleshipAi {
