...
const std::string& GameMessage::_type_name() {
	static const std::string out("se.gigurra.aichallenge.GameMessage");
	return out;
}

const std::vector<long long>& GameMessage::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 1369439193061359418LL << 7939421773867622329LL;
	return out;
}

const std::vector<short>& GameMessage::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << -15038 << -5220;
	return out;
}

const std::vector<std::string>& GameMessage::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.Message" << "se.gigurra.aichallenge.GameMessage";
	return out;
}

const std::vector<std::string>& GameMessage::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "xUI" << "65w";
	return out;
}

const std::string& GameMessage::_type_ids_16bit_base64_string() {
	static const std::string out("xUI65w");
	return out;
}

const std::string& GameMessage::_type_id_16bit_base64() {
	static const std::string out("65w");
	return out;
}
