...
const std::string& Message::_type_name() {
	static const std::string out("se.gigurra.aichallenge.Message");
	return out;
}

const std::vector<long long>& Message::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 1369439193061359418LL;
	return out;
}

const std::vector<short>& Message::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << -15038;
	return out;
}

const std::vector<std::string>& Message::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.Message";
	return out;
}

const std::vector<std::string>& Message::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "xUI";
	return out;
}

const std::string& Message::_type_ids_16bit_base64_string() {
	static const std::string out("xUI");
	return out;
}
