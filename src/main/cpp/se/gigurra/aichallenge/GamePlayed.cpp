...
const std::string& GamePlayed::_type_name() {
	static const std::string out("se.gigurra.aichallenge.GamePlayed");
	return out;
}

const std::vector<long long>& GamePlayed::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 2600061850285819111LL;
	return out;
}

const std::vector<short>& GamePlayed::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << 18746;
	return out;
}

const std::vector<std::string>& GamePlayed::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.GamePlayed";
	return out;
}

const std::vector<std::string>& GamePlayed::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "STo";
	return out;
}

const std::string& GamePlayed::_type_ids_16bit_base64_string() {
	static const std::string out("STo");
	return out;
}
