...
const std::string& PlayGame::_type_name() {
	static const std::string out("se.gigurra.aichallenge.PlayGame");
	return out;
}

const std::vector<long long>& PlayGame::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 1369439193061359418LL << 4196117780367695772LL;
	return out;
}

const std::vector<short>& PlayGame::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << -15038 << 19266;
	return out;
}

const std::vector<std::string>& PlayGame::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.Message" << "se.gigurra.aichallenge.PlayGame";
	return out;
}

const std::vector<std::string>& PlayGame::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "xUI" << "S0I";
	return out;
}

const std::string& PlayGame::_type_ids_16bit_base64_string() {
	static const std::string out("xUIS0I");
	return out;
}

const std::string& PlayGame::_type_id_16bit_base64() {
	static const std::string out("S0I");
	return out;
}
