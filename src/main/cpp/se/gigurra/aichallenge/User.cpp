...
const std::string& User::_type_name() {
	static const std::string out("se.gigurra.aichallenge.User");
	return out;
}

const std::vector<long long>& User::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 1870692920178448898LL;
	return out;
}

const std::vector<short>& User::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << 26014;
	return out;
}

const std::vector<std::string>& User::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.User";
	return out;
}

const std::vector<std::string>& User::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "ZZ4";
	return out;
}

const std::string& User::_type_ids_16bit_base64_string() {
	static const std::string out("ZZ4");
	return out;
}
