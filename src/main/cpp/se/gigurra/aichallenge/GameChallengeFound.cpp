...
const std::string& GameChallengeFound::_type_name() {
	static const std::string out("se.gigurra.aichallenge.GameChallengeFound");
	return out;
}

const std::vector<long long>& GameChallengeFound::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 1369439193061359418LL << 4960850565215976785LL;
	return out;
}

const std::vector<short>& GameChallengeFound::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << -15038 << -26051;
	return out;
}

const std::vector<std::string>& GameChallengeFound::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.Message" << "se.gigurra.aichallenge.GameChallengeFound";
	return out;
}

const std::vector<std::string>& GameChallengeFound::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "xUI" << "mj0";
	return out;
}

const std::string& GameChallengeFound::_type_ids_16bit_base64_string() {
	static const std::string out("xUImj0");
	return out;
}

const std::string& GameChallengeFound::_type_id_16bit_base64() {
	static const std::string out("mj0");
	return out;
}
