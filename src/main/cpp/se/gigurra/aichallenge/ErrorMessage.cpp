...
const std::string& ErrorMessage::_type_name() {
	static const std::string out("se.gigurra.aichallenge.ErrorMessage");
	return out;
}

const std::vector<long long>& ErrorMessage::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 1369439193061359418LL << 7600043425435053312LL;
	return out;
}

const std::vector<short>& ErrorMessage::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << -15038 << 15865;
	return out;
}

const std::vector<std::string>& ErrorMessage::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.Message" << "se.gigurra.aichallenge.ErrorMessage";
	return out;
}

const std::vector<std::string>& ErrorMessage::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "xUI" << "Pfk";
	return out;
}

const std::string& ErrorMessage::_type_ids_16bit_base64_string() {
	static const std::string out("xUIPfk");
	return out;
}

const std::string& ErrorMessage::_type_id_16bit_base64() {
	static const std::string out("Pfk");
	return out;
}
