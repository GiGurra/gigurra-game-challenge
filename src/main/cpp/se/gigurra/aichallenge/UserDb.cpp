...
const std::string& UserDb::_type_name() {
	static const std::string out("se.gigurra.aichallenge.UserDb");
	return out;
}

const std::vector<long long>& UserDb::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 7303451540181597977LL;
	return out;
}

const std::vector<short>& UserDb::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << 6980;
	return out;
}

const std::vector<std::string>& UserDb::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.UserDb";
	return out;
}

const std::vector<std::string>& UserDb::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "G0Q";
	return out;
}

const std::string& UserDb::_type_ids_16bit_base64_string() {
	static const std::string out("G0Q");
	return out;
}
