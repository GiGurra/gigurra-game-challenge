...
#ifndef SE_GIGURRA_AICHALLENGE_GAMES_GO_REQUESTFROMSERVER
#define SE_GIGURRA_AICHALLENGE_GAMES_GO_REQUESTFROMSERVER
...
class RequestFromServer : public GoMessage /* custom_ifcs_begin *//* custom_ifcs_end */ {
private:
public:
	RequestFromServer();
 ...
 ********************************************************************************************************************/	 		  
	...
	static const long long _type_id = 2788340059497092150LL;
	static const std::vector<long long>& _type_ids();

	static const short _type_id_16bit = -30682;
