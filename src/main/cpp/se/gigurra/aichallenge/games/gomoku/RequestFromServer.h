...
#ifndef SE_GIGURRA_AICHALLENGE_GAMES_GOMOKU_REQUESTFROMSERVER
#define SE_GIGURRA_AICHALLENGE_GAMES_GOMOKU_REQUESTFROMSERVER
...
class RequestFromServer : public GomokuMessage /* custom_ifcs_begin *//* custom_ifcs_end */ {
private:
public:
	RequestFromServer();
 ...
 ********************************************************************************************************************/	 		  
	...
	static const long long _type_id = 1660000543956266627LL;
	static const std::vector<long long>& _type_ids();

	static const short _type_id_16bit = -12709;
