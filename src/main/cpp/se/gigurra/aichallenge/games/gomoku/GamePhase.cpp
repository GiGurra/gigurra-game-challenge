...
const std::vector<se::gigurra::aichallenge::games::gomoku::GamePhase>& get_enum_values(const se::gigurra::aichallenge::games::gomoku::GamePhase /* type_evidence */) {
	static const std::vector<se::gigurra::aichallenge::games::gomoku::GamePhase> out = se::gigurra::aichallenge::games::gomoku::_mk_GamePhase_enum_values();
	return out;
}
...
se::gigurra::aichallenge::games::gomoku::GamePhase get_enum_value(const se::gigurra::aichallenge::games::gomoku::GamePhase /* type_evidence */, const std::string& enumName) {
	static const std::map<std::string, se::gigurra::aichallenge::games::gomoku::GamePhase> lkup = se::gigurra::aichallenge::games::gomoku::_mk_GamePhase_enum_lkup_map();
	std::map<std::string, se::gigurra::aichallenge::games::gomoku::GamePhase>::const_iterator it = lkup.find(enumName);
	return it != lkup.end() ? it->second : se::gigurra::aichallenge::games::gomoku::GamePhase_UNKNOWN;
}

const std::vector<std::string>& get_enum_names(const se::gigurra::aichallenge::games::gomoku::GamePhase /* type_evidence */) {
	static const std::vector<std::string> out = se::gigurra::aichallenge::games::gomoku::_mk_GamePhase_enum_names();
	return out;
}
...
const std::string& get_enum_name(const se::gigurra::aichallenge::games::gomoku::GamePhase enumValue) {
	...
	switch (enumValue) {
		case se::gigurra::aichallenge::games::gomoku::GamePhase_JOINING:
			return JOINING_name;
		case se::gigurra::aichallenge::games::gomoku::GamePhase_PLAYING:
			return PLAYING_name;
		case se::gigurra::aichallenge::games::gomoku::GamePhase_GAME_OVER:
			return GAME_OVER_name;
		case se::gigurra::aichallenge::games::gomoku::GamePhase_UNKNOWN:
			return UNKNOWN_name;
		default:
			return UNKNOWN_name;
	}
