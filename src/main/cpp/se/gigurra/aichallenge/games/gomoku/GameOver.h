...
#ifndef SE_GIGURRA_AICHALLENGE_GAMES_GOMOKU_GAMEOVER
#define SE_GIGURRA_AICHALLENGE_GAMES_GOMOKU_GAMEOVER
...
class GameOver : public GomokuMessage /* custom_ifcs_begin *//* custom_ifcs_end */ {
private:
	std::string m_reason;
	std::string m_winner;
	std::string m_loser;
 ...
 ********************************************************************************************************************/	 		  
	...
	static const long long _type_id = 910702424229933393LL;
	static const std::vector<long long>& _type_ids();

	static const short _type_id_16bit = 21266;
