...
#ifndef SE_GIGURRA_AICHALLENGE_GAMES_GOMOKU_BOARD
#define SE_GIGURRA_AICHALLENGE_GAMES_GOMOKU_BOARD
...
private:
	std::vector<std::vector<Team> >  m_positions;
	bool _m_positions_isSet;

public:
	Board();
	Board(const std::vector<std::vector<Team> > & positions);
	virtual ~Board();

	const std::vector<std::vector<Team> > & getPositions() const;

	std::vector<std::vector<Team> > & getPositionsMutable();

	Board& setPositions(const std::vector<std::vector<Team> > & positions);

	/* custom_methods_begin *//* custom_methods_end */

	bool hasPositions() const;

	Board& unsetPositions();
...
public:
	...
	Board& _setPositionsSet(const bool state, const mgen::FieldSetDepth depth);
 ...
 ********************************************************************************************************************/	 		  
	...
	static const long long _type_id = 7972794693990491050LL;
	static const std::vector<long long>& _type_ids();

	static const short _type_id_16bit = -2985;
