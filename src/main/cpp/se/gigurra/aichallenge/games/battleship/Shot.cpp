...
const std::string& Shot::_type_name() {
	static const std::string out("se.gigurra.aichallenge.games.battleship.Shot");
	return out;
}

const std::vector<long long>& Shot::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 7446599600640505600LL;
	return out;
}

const std::vector<short>& Shot::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << 808;
	return out;
}

const std::vector<std::string>& Shot::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.games.battleship.Shot";
	return out;
}

const std::vector<std::string>& Shot::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "Ayg";
	return out;
}

const std::string& Shot::_type_ids_16bit_base64_string() {
	static const std::string out("Ayg");
	return out;
}
