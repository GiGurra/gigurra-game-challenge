...
const mgen::Field * GameState::_fieldByName(const std::string& name) const {
	static const std::map<std::string, const mgen::Field*> name2meta = mgen::make_map<std::string, const mgen::Field*>()("redPlayer", &GameState::_field_redPlayer_metadata())("bluePlayer", &GameState::_field_bluePlayer_metadata())("phase", &GameState::_field_phase_metadata());
...
const std::string& GameState::_type_name() {
	static const std::string out("se.gigurra.aichallenge.games.battleship.GameState");
	return out;
}

const std::vector<long long>& GameState::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 6762107626409611267LL;
	return out;
}

const std::vector<short>& GameState::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << -11743;
	return out;
}

const std::vector<std::string>& GameState::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.games.battleship.GameState";
	return out;
}

const std::vector<std::string>& GameState::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "0iE";
	return out;
}

const std::string& GameState::_type_ids_16bit_base64_string() {
	static const std::string out("0iE");
	return out;
}
...
const std::vector<mgen::Field>& GameState::_field_metadatas() {
	static const std::vector<mgen::Field> out = mgen::make_vector<mgen::Field>() << _field_redPlayer_metadata() << _field_bluePlayer_metadata() << _field_phase_metadata();
	return out;
}
