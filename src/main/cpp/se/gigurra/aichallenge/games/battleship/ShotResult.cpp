...
const std::string& ShotResult::_type_name() {
	static const std::string out("se.gigurra.aichallenge.games.battleship.ShotResult");
	return out;
}

const std::vector<long long>& ShotResult::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 1369439193061359418LL << 7939421773867622329LL << 7379711854769594968LL << 6666710255651832799LL;
	return out;
}

const std::vector<short>& ShotResult::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << -15038 << -5220 << 2093 << -24797;
	return out;
}

const std::vector<std::string>& ShotResult::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.Message" << "se.gigurra.aichallenge.GameMessage" << "se.gigurra.aichallenge.games.battleship.BattleshipMessage" << "se.gigurra.aichallenge.games.battleship.ShotResult";
	return out;
}

const std::vector<std::string>& ShotResult::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "xUI" << "65w" << "CC0" << "nyM";
	return out;
}

const std::string& ShotResult::_type_ids_16bit_base64_string() {
	static const std::string out("xUI65wCC0nyM");
	return out;
}

const std::string& ShotResult::_type_id_16bit_base64() {
	static const std::string out("nyM");
	return out;
}
