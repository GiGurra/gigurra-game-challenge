...
const std::string& Vec2::_type_name() {
	static const std::string out("se.gigurra.aichallenge.games.battleship.Vec2");
	return out;
}

const std::vector<long long>& Vec2::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 7981049559379880590LL;
	return out;
}

const std::vector<short>& Vec2::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << -28589;
	return out;
}

const std::vector<std::string>& Vec2::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.games.battleship.Vec2";
	return out;
}

const std::vector<std::string>& Vec2::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "kFM";
	return out;
}

const std::string& Vec2::_type_ids_16bit_base64_string() {
	static const std::string out("kFM");
	return out;
}
