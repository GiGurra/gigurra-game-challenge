...
const std::string& Segment::_type_name() {
	static const std::string out("se.gigurra.aichallenge.games.battleship.Segment");
	return out;
}

const std::vector<long long>& Segment::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 8815419055472982183LL;
	return out;
}

const std::vector<short>& Segment::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << 5132;
	return out;
}

const std::vector<std::string>& Segment::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.games.battleship.Segment";
	return out;
}

const std::vector<std::string>& Segment::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "FAw";
	return out;
}

const std::string& Segment::_type_ids_16bit_base64_string() {
	static const std::string out("FAw");
	return out;
}
