...
const std::string& Ship::_type_name() {
	static const std::string out("se.gigurra.aichallenge.games.battleship.Ship");
	return out;
}

const std::vector<long long>& Ship::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 8944528462373442872LL;
	return out;
}

const std::vector<short>& Ship::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << -5878;
	return out;
}

const std::vector<std::string>& Ship::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.games.battleship.Ship";
	return out;
}

const std::vector<std::string>& Ship::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "6Qo";
	return out;
}

const std::string& Ship::_type_ids_16bit_base64_string() {
	static const std::string out("6Qo");
	return out;
}
