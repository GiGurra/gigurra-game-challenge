...
const mgen::Field * Player::_fieldByName(const std::string& name) const {
	static const std::map<std::string, const mgen::Field*> name2meta = mgen::make_map<std::string, const mgen::Field*>()("name", &Player::_field_name_metadata())("shotsFired", &Player::_field_shotsFired_metadata())("shotsReceived", &Player::_field_shotsReceived_metadata())("ships", &Player::_field_ships_metadata());
...
const std::string& Player::_type_name() {
	static const std::string out("se.gigurra.aichallenge.games.battleship.Player");
	return out;
}

const std::vector<long long>& Player::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 8982872967636735559LL;
	return out;
}

const std::vector<short>& Player::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << -546;
	return out;
}

const std::vector<std::string>& Player::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "se.gigurra.aichallenge.games.battleship.Player";
	return out;
}

const std::vector<std::string>& Player::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "/d4";
	return out;
}

const std::string& Player::_type_ids_16bit_base64_string() {
	static const std::string out("/d4");
	return out;
}
...
const std::vector<mgen::Field>& Player::_field_metadatas() {
	static const std::vector<mgen::Field> out = mgen::make_vector<mgen::Field>() << _field_name_metadata() << _field_shotsFired_metadata() << _field_shotsReceived_metadata() << _field_ships_metadata();
	return out;
}
