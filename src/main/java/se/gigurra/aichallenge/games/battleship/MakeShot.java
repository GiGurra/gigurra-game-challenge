 ...
 ********************************************************************************************************************/	 		  
	...
	public static final long _TYPE_ID = 1589954755466171082L;

	public static final long[] _TYPE_IDS = { se.gigurra.aichallenge.Message._TYPE_ID, se.gigurra.aichallenge.GameMessage._TYPE_ID, se.gigurra.aichallenge.games.battleship.BattleshipMessage._TYPE_ID, se.gigurra.aichallenge.games.battleship.MakeShot._TYPE_ID };

	public static final short _TYPE_ID_16BIT = 27986;

	public static final short[] _TYPE_IDS_16BIT = { se.gigurra.aichallenge.Message._TYPE_ID_16BIT, se.gigurra.aichallenge.GameMessage._TYPE_ID_16BIT, se.gigurra.aichallenge.games.battleship.BattleshipMessage._TYPE_ID_16BIT, se.gigurra.aichallenge.games.battleship.MakeShot._TYPE_ID_16BIT };

	public static final String _TYPE_ID_16BIT_BASE64 = "bVI";

	public static final String[] _TYPE_IDS_16BIT_BASE64 = { se.gigurra.aichallenge.Message._TYPE_ID_16BIT_BASE64, se.gigurra.aichallenge.GameMessage._TYPE_ID_16BIT_BASE64, se.gigurra.aichallenge.games.battleship.BattleshipMessage._TYPE_ID_16BIT_BASE64, se.gigurra.aichallenge.games.battleship.MakeShot._TYPE_ID_16BIT_BASE64 };

	public static final String _TYPE_IDS_16BIT_BASE64_STRING = se.gigurra.aichallenge.Message._TYPE_ID_16BIT_BASE64 + se.gigurra.aichallenge.GameMessage._TYPE_ID_16BIT_BASE64 + se.gigurra.aichallenge.games.battleship.BattleshipMessage._TYPE_ID_16BIT_BASE64 + se.gigurra.aichallenge.games.battleship.MakeShot._TYPE_ID_16BIT_BASE64;

	public static final String _TYPE_NAME = "se.gigurra.aichallenge.games.battleship.MakeShot";

	public static final String[] _TYPE_NAMES = { se.gigurra.aichallenge.Message._TYPE_NAME, se.gigurra.aichallenge.GameMessage._TYPE_NAME, se.gigurra.aichallenge.games.battleship.BattleshipMessage._TYPE_NAME, se.gigurra.aichallenge.games.battleship.MakeShot._TYPE_NAME };

	public static final Field _shot_METADATA = new Field("se.gigurra.aichallenge.games.battleship.MakeShot", "shot", new se.culvertsoft.mgen.api.model.RuntimeClassType("se.gigurra.aichallenge.games.battleship.Shot", 7446599600640505600L), null, (short)19108);
