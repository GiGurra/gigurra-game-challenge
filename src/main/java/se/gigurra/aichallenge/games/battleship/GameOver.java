 ...
 ********************************************************************************************************************/	 		  
	...
	public static final long _TYPE_ID = 2842249200045117097L;

	public static final long[] _TYPE_IDS = { se.gigurra.aichallenge.Message._TYPE_ID, se.gigurra.aichallenge.GameMessage._TYPE_ID, se.gigurra.aichallenge.games.battleship.BattleshipMessage._TYPE_ID, se.gigurra.aichallenge.games.battleship.GameOver._TYPE_ID };

	public static final short _TYPE_ID_16BIT = -3531;

	public static final short[] _TYPE_IDS_16BIT = { se.gigurra.aichallenge.Message._TYPE_ID_16BIT, se.gigurra.aichallenge.GameMessage._TYPE_ID_16BIT, se.gigurra.aichallenge.games.battleship.BattleshipMessage._TYPE_ID_16BIT, se.gigurra.aichallenge.games.battleship.GameOver._TYPE_ID_16BIT };

	public static final String _TYPE_ID_16BIT_BASE64 = "8jU";

	public static final String[] _TYPE_IDS_16BIT_BASE64 = { se.gigurra.aichallenge.Message._TYPE_ID_16BIT_BASE64, se.gigurra.aichallenge.GameMessage._TYPE_ID_16BIT_BASE64, se.gigurra.aichallenge.games.battleship.BattleshipMessage._TYPE_ID_16BIT_BASE64, se.gigurra.aichallenge.games.battleship.GameOver._TYPE_ID_16BIT_BASE64 };

	public static final String _TYPE_IDS_16BIT_BASE64_STRING = se.gigurra.aichallenge.Message._TYPE_ID_16BIT_BASE64 + se.gigurra.aichallenge.GameMessage._TYPE_ID_16BIT_BASE64 + se.gigurra.aichallenge.games.battleship.BattleshipMessage._TYPE_ID_16BIT_BASE64 + se.gigurra.aichallenge.games.battleship.GameOver._TYPE_ID_16BIT_BASE64;

	public static final String _TYPE_NAME = "se.gigurra.aichallenge.games.battleship.GameOver";

	public static final String[] _TYPE_NAMES = { se.gigurra.aichallenge.Message._TYPE_NAME, se.gigurra.aichallenge.GameMessage._TYPE_NAME, se.gigurra.aichallenge.games.battleship.BattleshipMessage._TYPE_NAME, se.gigurra.aichallenge.games.battleship.GameOver._TYPE_NAME };

	public static final Field _reason_METADATA = new Field("se.gigurra.aichallenge.games.battleship.GameOver", "reason", se.culvertsoft.mgen.api.model.StringType.INSTANCE, null, (short)-15867);
	public static final Field _winner_METADATA = new Field("se.gigurra.aichallenge.games.battleship.GameOver", "winner", se.culvertsoft.mgen.api.model.StringType.INSTANCE, null, (short)-7291);
	public static final Field _loser_METADATA = new Field("se.gigurra.aichallenge.games.battleship.GameOver", "loser", se.culvertsoft.mgen.api.model.StringType.INSTANCE, null, (short)9621);
	public static final Field _endState_METADATA = new Field("se.gigurra.aichallenge.games.battleship.GameOver", "endState", new se.culvertsoft.mgen.api.model.RuntimeClassType("se.gigurra.aichallenge.games.battleship.GameState", 6762107626409611267L), null, (short)2994);
