 ...
 ********************************************************************************************************************/	 		  
	...
	public static final long _TYPE_ID = 8815419055472982183L;

	public static final long[] _TYPE_IDS = { se.gigurra.aichallenge.games.battleship.Segment._TYPE_ID };

	public static final short _TYPE_ID_16BIT = 5132;

	public static final short[] _TYPE_IDS_16BIT = { se.gigurra.aichallenge.games.battleship.Segment._TYPE_ID_16BIT };

	public static final String _TYPE_ID_16BIT_BASE64 = "FAw";

	public static final String[] _TYPE_IDS_16BIT_BASE64 = { se.gigurra.aichallenge.games.battleship.Segment._TYPE_ID_16BIT_BASE64 };

	public static final String _TYPE_IDS_16BIT_BASE64_STRING = se.gigurra.aichallenge.games.battleship.Segment._TYPE_ID_16BIT_BASE64;

	public static final String _TYPE_NAME = "se.gigurra.aichallenge.games.battleship.Segment";

	public static final String[] _TYPE_NAMES = { se.gigurra.aichallenge.games.battleship.Segment._TYPE_NAME };

	public static final Field _alive_METADATA = new Field("se.gigurra.aichallenge.games.battleship.Segment", "alive", se.culvertsoft.mgen.api.model.BoolType.INSTANCE, null, (short)12135);
	public static final Field _pos_METADATA = new Field("se.gigurra.aichallenge.games.battleship.Segment", "pos", new se.culvertsoft.mgen.api.model.RuntimeClassType("se.gigurra.aichallenge.games.battleship.Vec2", 7981049559379880590L), null, (short)16756);
