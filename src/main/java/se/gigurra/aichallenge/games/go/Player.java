 ...
 ********************************************************************************************************************/	 		  
	...
	public static final long _TYPE_ID = 6275090646202330472L;

	public static final long[] _TYPE_IDS = { se.gigurra.aichallenge.games.go.Player._TYPE_ID };

	public static final short _TYPE_ID_16BIT = 5961;

	public static final short[] _TYPE_IDS_16BIT = { se.gigurra.aichallenge.games.go.Player._TYPE_ID_16BIT };

	public static final String _TYPE_ID_16BIT_BASE64 = "F0k";

	public static final String[] _TYPE_IDS_16BIT_BASE64 = { se.gigurra.aichallenge.games.go.Player._TYPE_ID_16BIT_BASE64 };

	public static final String _TYPE_IDS_16BIT_BASE64_STRING = se.gigurra.aichallenge.games.go.Player._TYPE_ID_16BIT_BASE64;

	public static final String _TYPE_NAME = "se.gigurra.aichallenge.games.go.Player";

	public static final String[] _TYPE_NAMES = { se.gigurra.aichallenge.games.go.Player._TYPE_NAME };

	public static final Field _name_METADATA = new Field("se.gigurra.aichallenge.games.go.Player", "name", se.culvertsoft.mgen.api.model.StringType.INSTANCE, null, (short)-28058);
	public static final Field _team_METADATA = new Field("se.gigurra.aichallenge.games.go.Player", "team", se.gigurra.aichallenge.games.go.Team._TYPE, null, (short)-1585);
