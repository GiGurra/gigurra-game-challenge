 ...
 ********************************************************************************************************************/	 		  
	...
	public static final long _TYPE_ID = 988960440607832827L;

	public static final long[] _TYPE_IDS = { se.gigurra.aichallenge.games.gomoku.Vec2._TYPE_ID };

	public static final short _TYPE_ID_16BIT = -8029;

	public static final short[] _TYPE_IDS_16BIT = { se.gigurra.aichallenge.games.gomoku.Vec2._TYPE_ID_16BIT };

	public static final String _TYPE_ID_16BIT_BASE64 = "4KM";

	public static final String[] _TYPE_IDS_16BIT_BASE64 = { se.gigurra.aichallenge.games.gomoku.Vec2._TYPE_ID_16BIT_BASE64 };

	public static final String _TYPE_IDS_16BIT_BASE64_STRING = se.gigurra.aichallenge.games.gomoku.Vec2._TYPE_ID_16BIT_BASE64;

	public static final String _TYPE_NAME = "se.gigurra.aichallenge.games.gomoku.Vec2";

	public static final String[] _TYPE_NAMES = { se.gigurra.aichallenge.games.gomoku.Vec2._TYPE_NAME };

	public static final Field _x_METADATA = new Field("se.gigurra.aichallenge.games.gomoku.Vec2", "x", se.culvertsoft.mgen.api.model.Int32Type.INSTANCE, null, (short)7791);
	public static final Field _y_METADATA = new Field("se.gigurra.aichallenge.games.gomoku.Vec2", "y", se.culvertsoft.mgen.api.model.Int32Type.INSTANCE, null, (short)3662);
