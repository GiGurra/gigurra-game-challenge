 ...
 ********************************************************************************************************************/	 		  
	...
	public static final long _TYPE_ID = 8695176692006056988L;

	public static final long[] _TYPE_IDS = { se.gigurra.aichallenge.games.gomoku.GameState._TYPE_ID };

	public static final short _TYPE_ID_16BIT = 20714;

	public static final short[] _TYPE_IDS_16BIT = { se.gigurra.aichallenge.games.gomoku.GameState._TYPE_ID_16BIT };

	public static final String _TYPE_ID_16BIT_BASE64 = "UOo";

	public static final String[] _TYPE_IDS_16BIT_BASE64 = { se.gigurra.aichallenge.games.gomoku.GameState._TYPE_ID_16BIT_BASE64 };

	public static final String _TYPE_IDS_16BIT_BASE64_STRING = se.gigurra.aichallenge.games.gomoku.GameState._TYPE_ID_16BIT_BASE64;

	public static final String _TYPE_NAME = "se.gigurra.aichallenge.games.gomoku.GameState";

	public static final String[] _TYPE_NAMES = { se.gigurra.aichallenge.games.gomoku.GameState._TYPE_NAME };

	public static final Field _redPlayer_METADATA = new Field("se.gigurra.aichallenge.games.gomoku.GameState", "redPlayer", new se.culvertsoft.mgen.api.model.RuntimeClassType("se.gigurra.aichallenge.games.gomoku.Player", 2260816355230889073L), null, (short)-7294);
	public static final Field _bluePlayer_METADATA = new Field("se.gigurra.aichallenge.games.gomoku.GameState", "bluePlayer", new se.culvertsoft.mgen.api.model.RuntimeClassType("se.gigurra.aichallenge.games.gomoku.Player", 2260816355230889073L), null, (short)10760);
	public static final Field _board_METADATA = new Field("se.gigurra.aichallenge.games.gomoku.GameState", "board", new se.culvertsoft.mgen.api.model.RuntimeClassType("se.gigurra.aichallenge.games.gomoku.Board", 7972794693990491050L), null, (short)12077);
	public static final Field _phase_METADATA = new Field("se.gigurra.aichallenge.games.gomoku.GameState", "phase", se.gigurra.aichallenge.games.gomoku.GamePhase._TYPE, null, (short)7625);
	...
	public static final Field[] _FIELDS = { _redPlayer_METADATA, _bluePlayer_METADATA, _board_METADATA, _phase_METADATA };
