...
public class WelcomeMessage extends Message /* custom_ifcs_begin *//* custom_ifcs_end */ {
	...
	public java.util.List<GameSelection> getAvailableGamesCopy() {
		java.util.List<GameSelection> out = null;
		final java.util.List<GameSelection> var0 = getAvailableGames();
		if (var0 != null) {
			out = new java.util.ArrayList<GameSelection>(var0.size());
			for (final GameSelection var1 : var0) {
				GameSelection var2 = null;
				var2 = var1;
				out.add(var2);
			}
		} else {
 ...
 ********************************************************************************************************************/	 		  
	...
	public static final long _TYPE_ID = 7150772769938527389L;

	public static final long[] _TYPE_IDS = { se.gigurra.aichallenge.Message._TYPE_ID, se.gigurra.aichallenge.WelcomeMessage._TYPE_ID };

	public static final short _TYPE_ID_16BIT = -28231;

	public static final short[] _TYPE_IDS_16BIT = { se.gigurra.aichallenge.Message._TYPE_ID_16BIT, se.gigurra.aichallenge.WelcomeMessage._TYPE_ID_16BIT };

	public static final String _TYPE_ID_16BIT_BASE64 = "kbk";

	public static final String[] _TYPE_IDS_16BIT_BASE64 = { se.gigurra.aichallenge.Message._TYPE_ID_16BIT_BASE64, se.gigurra.aichallenge.WelcomeMessage._TYPE_ID_16BIT_BASE64 };

	public static final String _TYPE_IDS_16BIT_BASE64_STRING = se.gigurra.aichallenge.Message._TYPE_ID_16BIT_BASE64 + se.gigurra.aichallenge.WelcomeMessage._TYPE_ID_16BIT_BASE64;

	public static final String _TYPE_NAME = "se.gigurra.aichallenge.WelcomeMessage";

	public static final String[] _TYPE_NAMES = { se.gigurra.aichallenge.Message._TYPE_NAME, se.gigurra.aichallenge.WelcomeMessage._TYPE_NAME };

	public static final Field _msg_METADATA = new Field("se.gigurra.aichallenge.WelcomeMessage", "msg", se.culvertsoft.mgen.api.model.StringType.INSTANCE, null, (short)21741);
	public static final Field _availableGames_METADATA = new Field("se.gigurra.aichallenge.WelcomeMessage", "availableGames", new se.culvertsoft.mgen.api.model.ListType(se.gigurra.aichallenge.GameSelection._TYPE), null, (short)-11213);
