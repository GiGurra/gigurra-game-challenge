 ...
 ********************************************************************************************************************/	 		  
	...
	public static final long _TYPE_ID = 1870692920178448898L;

	public static final long[] _TYPE_IDS = { se.gigurra.aichallenge.User._TYPE_ID };

	public static final short _TYPE_ID_16BIT = 26014;

	public static final short[] _TYPE_IDS_16BIT = { se.gigurra.aichallenge.User._TYPE_ID_16BIT };

	public static final String _TYPE_ID_16BIT_BASE64 = "ZZ4";

	public static final String[] _TYPE_IDS_16BIT_BASE64 = { se.gigurra.aichallenge.User._TYPE_ID_16BIT_BASE64 };

	public static final String _TYPE_IDS_16BIT_BASE64_STRING = se.gigurra.aichallenge.User._TYPE_ID_16BIT_BASE64;

	public static final String _TYPE_NAME = "se.gigurra.aichallenge.User";

	public static final String[] _TYPE_NAMES = { se.gigurra.aichallenge.User._TYPE_NAME };

	public static final Field _name_METADATA = new Field("se.gigurra.aichallenge.User", "name", se.culvertsoft.mgen.api.model.StringType.INSTANCE, null, (short)-28058);
	public static final Field _password_METADATA = new Field("se.gigurra.aichallenge.User", "password", se.culvertsoft.mgen.api.model.StringType.INSTANCE, null, (short)5242);
