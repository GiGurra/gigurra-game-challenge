...
public class GamePlayed extends se.culvertsoft.mgen.javapack.classes.MGenBase /* custom_ifcs_begin *//* custom_ifcs_end */ {
	...
	public GameSelection getGameTypeCopy() {
		return m_gameType;
	}

	public java.util.List<String> getPlayersCopy() {
		java.util.List<String> out = null;
		final java.util.List<String> var0 = getPlayers();
		if (var0 != null) {
	...
	public java.util.List<String> getWinnersCopy() {
		java.util.List<String> out = null;
		final java.util.List<String> var0 = getWinners();
		if (var0 != null) {
			out = new java.util.ArrayList<String>(var0.size());
			for (final String var1 : var0) {
				String var2 = null;
 ...
 ********************************************************************************************************************/	 		  
	...
	public static final long _TYPE_ID = 2600061850285819111L;

	public static final long[] _TYPE_IDS = { se.gigurra.aichallenge.GamePlayed._TYPE_ID };

	public static final short _TYPE_ID_16BIT = 18746;

	public static final short[] _TYPE_IDS_16BIT = { se.gigurra.aichallenge.GamePlayed._TYPE_ID_16BIT };

	public static final String _TYPE_ID_16BIT_BASE64 = "STo";

	public static final String[] _TYPE_IDS_16BIT_BASE64 = { se.gigurra.aichallenge.GamePlayed._TYPE_ID_16BIT_BASE64 };

	public static final String _TYPE_IDS_16BIT_BASE64_STRING = se.gigurra.aichallenge.GamePlayed._TYPE_ID_16BIT_BASE64;

	public static final String _TYPE_NAME = "se.gigurra.aichallenge.GamePlayed";

	public static final String[] _TYPE_NAMES = { se.gigurra.aichallenge.GamePlayed._TYPE_NAME };

	public static final Field _gameType_METADATA = new Field("se.gigurra.aichallenge.GamePlayed", "gameType", se.gigurra.aichallenge.GameSelection._TYPE, null, (short)-27076);
	public static final Field _players_METADATA = new Field("se.gigurra.aichallenge.GamePlayed", "players", new se.culvertsoft.mgen.api.model.ListType(se.culvertsoft.mgen.api.model.StringType.INSTANCE), null, (short)29583);
	public static final Field _winners_METADATA = new Field("se.gigurra.aichallenge.GamePlayed", "winners", new se.culvertsoft.mgen.api.model.ListType(se.culvertsoft.mgen.api.model.StringType.INSTANCE), null, (short)1721);
